...
class IndexedStackTransitionScreen extends StatefulWidget {
  const IndexedStackTransitionScreen({super.key});

  @override
  State<IndexedStackTransitionScreen> createState() =>
      _IndexedStackTransitionExampleState();
}

class _IndexedStackTransitionExampleState
    extends State<IndexedStackTransitionScreen>
